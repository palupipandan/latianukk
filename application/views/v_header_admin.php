        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="<?php echo base_url()?>assets/adminLTE/#">See All Messages</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="<?php echo base_url()?>assets/adminLTE/#">View all</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown tasks-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer">
                <a href="<?php echo base_url()?>assets/adminLTE/#">View all tasks</a>
              </li>
            </ul>
          </li>
